...
$(TESTTARGET): $(OBJDIR) $(BINDIR) $(OBJDIRENTITY) $(OBJDIREVENTS) $(OBJDIRLEVEL) $(OBJDIRLIGHTS) $(OBJDIRUI) $(OBJDIRPHYSICS) $(OBJDIRRENDERER) $(OBJDIRSOUND) $(OBJSENTITY) $(OBJSEVENTS) $(OBJSLEVEL) $(OBJSLIGHTS) $(OBJSUI) $(OBJSPHYSICS) $(OBJSRENDERER) $(OBJSSOUND)
